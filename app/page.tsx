...
export default function Home() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      <main className="flex w-full max-w-3xl flex-col items-center justify-center py-10 px-6 dark:bg-black sm:items-start">
      
        <div className="mx-auto max-w-4xl px-4 py-10">
          {/* Top section */}
          <section className="mb-6">
            <h2 className="text-4xl font-extrabold tracking-tight text-gray-900">
              About <span className="text-[rgb(0,76,157)]">What would you like to do?</span>
            </h2>
          </section>
